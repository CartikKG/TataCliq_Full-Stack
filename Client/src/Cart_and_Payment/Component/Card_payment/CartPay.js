            ...
            <AccordionPanel pb={4}>
              <div style={{ display: "flex", gap: "10px" }}>
                <div style={{ width: "50%" }}>
                  ...
                  <Input className="carName" placeholder="Name On Card*" />
                </div>
                <div style={{ width: "50%" }}>
                  <div style={{ display: "flex", gap: "5px" }}>
                    ...
                    <Select mb={"10px"} placeholder="Expiry Year">
                      ...
                      <option value="option3">2032</option>
                    </Select>
                  </div>
                  ...
                  >
                    <Input className="cvv" w={"50%"} placeholder="CVV" />
            ...
            <AccordionPanel pb={4}>
              <div style={{ display: "flex", gap: "10px" }}>
                <div style={{ width: "50%" }}>
                  ...
                  <Input id="cName" placeholder="Name On Card*" />
                </div>
                <div style={{ width: "50%" }}>
                  <div style={{ display: "flex", gap: "5px" }}>
                    <Select placeholder="Expiry Month">
            ...
            <AccordionPanel pb={4}>
              <div style={{ display: "flex", gap: "10px" }}>
                <div style={{ width: "50%" }}>
                  ...
                  <Input className="cardNum" placeholder="Name On Card*" />
                </div>
                <div style={{ width: "50%" }}>
                  <div style={{ display: "flex", gap: "5px" }}>
                    <Select placeholder="Expiry Month">
                  ...
                  <div
                    style={{ display: "flex", justifyContent: "space-between" }}
                  >
                    <Input w={"50%"} className="cvv" placeholder="CVV" />
                    <Button onClick={paynow} w={"40%"} colorScheme="red">
                      Pay Now
                    </Button>
                  </div>
