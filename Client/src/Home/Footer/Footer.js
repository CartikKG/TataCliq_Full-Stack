...
function Footer(props) {
    return (
        <div>
            ...
            <div className='secondPart'>
             ...
             <div className='rightPart'> 
              ...
              <h6> Tata CLiQ Offerings</h6>
               ...
               <li> Boots for Women  |  Skechers |Malabargold  |  Fabindia  |  Utsa  |  Vark  |  Gia  |  LOV  |Sitemap  Boots for Women  | </li>
              </ul>
             </div>
            ...
            <div className='lasticon'> <div> © 2022 Tata CLiQ | All rights reserved </div></div>
            </div>
